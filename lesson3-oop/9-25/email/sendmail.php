...
$url = 'http://localhost/lesson3-oop/9-25/email/changePwd.php';
$userid = 'root';//用户名
$code = '123456';//密码
$code = md5($code);
$time = time();//时间戳
...
$smtpusermail = "18339232487@163.com"; //SMTP服务器的用户邮箱
$smtpemailto = "736567904@qq.com"; //发送给谁
$smtpuser = "18339232487@163.com"; //SMTP服务器的用户帐号
$smtppass = "mu1215"; //SMTP服务器的用户密码(这里是授权码)
$mailtitle = "找回密码"; //邮件主题
